...
var Emitter = function() {
    ...
    Dropzone = function() {
        function e(t, n) {
            var i, r, o;
            if (_classCallCheck(this, e), (i = _possibleConstructorReturn(this, _getPrototypeOf(e).call(this))).element = t, i.version = e.version, i.defaultOptions.previewTemplate = i.defaultOptions.previewTemplate.replace(/\n*/g, ""), i.clickableElements = [], i.listeners = [], i.files = [], "string" == typeof i.element && (i.element = document.querySelector(i.element)), !i.element || null == i.element.nodeType) throw new Error("Invalid dropzone element.");
            if (i.element.dropzone) throw new Error("Dropzone already attached.");
            e.instances.push(_assertThisInitialized(i)), i.element.dropzone = _assertThisInitialized(i);
            var a = null != (o = e.optionsForElement(i.element)) ? o : {};
            if (i.options = e.extend({}, i.defaultOptions, a, null != n ? n : {}), i.options.forceFallback || !e.isBrowserSupported()) return _possibleConstructorReturn(i, i.options.fallback.call(_assertThisInitialized(i)));
        ...
        return _inherits(e, Emitter), _createClass(e, null, [{
                    ...
                    addedfile: function(t) {
                        ...
                        if (this.element === this.previewsContainer && this.element.classList.add("dz-started"), this.previewsContainer) {
                            ...
                            var i = !0,
                                ...
                                o = void 0;
                            try {
                                for (var a, l = t.previewElement.querySelectorAll("[data-dz-name]")[Symbol.iterator](); !(i = (a = l.next()).done); i = !0) {
                                    var s = a.value;
                            ...
                            var u = !0,
                                ...
                                d = void 0;
                            try {
                                for (var p, h = t.previewElement.querySelectorAll("[data-dz-size]")[Symbol.iterator](); !(u = (p = h.next()).done); u = !0)(s = p.value).innerHTML = this.filesize(t.size)
                            } catch (i) {
                                c = !0, d = i
                            } finally {
                                try {
                            ...
                            var f = function(i) {
                                ...
                                y = void 0;
                            try {
                                for (var g, b = t.previewElement.querySelectorAll("[data-dz-remove]")[Symbol.iterator](); !(m = (g = b.next()).done); m = !0) g.value.addEventListener("click", f)
                            } catch (i) {
                                v = !0, y = i
                            } finally {
                                try {
                    ...
                    error: function(e, t) {
                        if (e.previewElement) {
                            ...
                            var n = !0,
                                ...
                                r = void 0;
                            try {
                                for (var o, a = e.previewElement.querySelectorAll("[data-dz-errormessage]")[Symbol.iterator](); !(n = (o = a.next()).done); n = !0) o.value.textContent = t
                            } catch (e) {
                                i = !0, r = e
                            } finally {
                                try {
            ...
            value: function() {
                var t = this;
                "form" === this.element.tagName && this.element.setAttribute("enctype", "multipart/form-data"), this.element.classList.contains("dropzone") && !this.element.querySelector(".dz-message") && this.element.appendChild(e.createElement('<div class="dz-default dz-message"> <img src="img/apply-loan/upload.png" alt="upload" /> <h4 class="dz-button" type="button">Drag and drop an image</h4><p class="dz-custom-upload-text">or to <span>Browse</span> choose a file <br> PNG,JPG,PDF</p></div>')), this.clickableElements.length && function n() {
                ...
                return this.on("uploadprogress", function() {
                    ...
                    events: {
                        ...
                        dragover: function(e) {
                            ...
                            return e.dataTransfer.dropEffect = "move" === n || "linkMove" === n ? "move" : "copy", s(e), t.emit("dragover", e)
                        },
            ...
            key: "destroy",
            value: function() {
                return this.disable(), this.removeAllFiles(!0), null != this.hiddenFileInput && this.hiddenFileInput.parentNode && (this.hiddenFileInput.parentNode.removeChild(this.hiddenFileInput), this.hiddenFileInput = null), delete this.element.dropzone, e.instances.splice(e.instances.indexOf(this), 1)
            }
        }, {
            ...
            value: function() {
                ...
                return "FORM" !== this.element.tagName ? (n = e.createElement('<form action="'.concat(this.options.url, '" enctype="multipart/form-data" method="').concat(this.options.method, '"></form>'))).appendChild(r) : (this.element.setAttribute("enctype", "multipart/form-data"), this.element.setAttribute("method", this.options.method)), null != n ? n : r
            }
        }, {
            ...
            value: function(e) {
                ...
                return function() {
                    ...
                    try {
                        for (var a, l = e[Symbol.iterator](); !(i = (a = l.next()).done); i = !0) {
                            var s, u = a.value;
                            null != u.webkitGetAsEntry && (s = u.webkitGetAsEntry()) ? s.isFile ? n.push(t.addFile(u.getAsFile())) : s.isDirectory ? n.push(t._addFilesFromDirectory(s, s.name)) : n.push(void 0) : null == u.getAsFile || null != u.kind && "file" !== u.kind ? n.push(void 0) : n.push(t.addFile(u.getAsFile()))
                        }
                    } catch (n) {
                        r = !0, o = n
                    } finally {
                        ...
                        if (0 < n.length) {
                            ...
                            try {
                                for (var l, s = n[Symbol.iterator](); !(r = (l = s.next()).done); r = !0) {
                                    ...
                                    }) : u.isDirectory && i._addFilesFromDirectory(u, "".concat(t, "/").concat(u.name))
                                }
                            } catch (n) {
                                o = !0, a = n
                            } finally {
            ...
            value: function(t, n, i, r, o) {
                ...
                return this.createThumbnail(t, n, i, r, !0, function(n, i) {
                    ...
                    return "image/jpeg" !== r && "image/jpg" !== r || (l = ExifRestore.restore(t.dataURL, l)), o(e.dataURItoBlob(l))
                })
            }
        }, {
            key: "createThumbnail",
                ...
                return a && (s.crossOrigin = a), s.onload = function() {
                    ...
                    return "undefined" != typeof EXIF && null !== EXIF && r && (a = function(e) {
                        ...
                        var a = l.options.resize.call(l, e, t, n, i),
                            ...
                            c = u.getContext("2d");
                        switch (u.width = a.trgWidth, u.height = a.trgHeight, 4 < r && (u.width = a.trgHeight, u.height = a.trgWidth), r) {
                            case 2:
            ...
            value: function(t) {
                ...
                try {
                    for (var o, a = t[Symbol.iterator](); !(n = (o = a.next()).done); n = !0) {
                        var l = o.value;
                        l.processing = !0, l.status = e.UPLOADING, this.emit("processing", l)
                    }
                } catch (t) {
                    i = !0, r = t
                } finally {
            ...
            value: function(t) {
                if (t.status === e.UPLOADING) {
                    var n = this._getFilesWithXhr(t.xhr),
                        ...
                        o = void 0;
                    try {
                        for (var a, l = n[Symbol.iterator](); !(i = (a = l.next()).done); i = !0) a.value.status = e.CANCELED
                    } catch (t) {
                        r = !0, o = t
                    } finally {
                        try {
            ...
            value: function(t) {
                ...
                this._transformFiles(t, function(i) {
                    if (n.options.chunking) {
                        var r = i[0];
                        t[0].upload.chunked = n.options.chunking && (n.options.forceChunking || r.size > n.options.chunkSize), t[0].upload.totalChunkCount = Math.ceil(r.size / n.options.chunkSize)
                    }
                    if (t[0].upload.chunked) {
                        ...
                        if (o.upload.finishedChunkUpload = function(i) {
                                var r = !0;
                                i.status = e.SUCCESS, i.dataBlock = null, i.xhr = null;
                        ...
                        for (var u = [], c = 0; c < t.length; c++) u[c] = {
            ...
            value: function(t, n) {
                var i = this,
                    ...
                    l = void 0;
                try {
                    for (var s, u = t[Symbol.iterator](); !(o = (s = u.next()).done); o = !0) s.value.xhr = r
                } catch (n) {
                    a = !0, l = n
                } finally {
                    try {
                ...
                r.open(c, d, !0), r.timeout = this.resolveOption(this.options.timeout, t), r.withCredentials = !!this.options.withCredentials, r.onload = function(e) {
                    i._finishedUploading(t, r, e)
                }, r.ontimeout = function() {
                    i._handleUploadError(t, r, "Request timedout after ".concat(i.options.timeout, " seconds"))
                }, r.onerror = function() {
                ...
                for (var h in this.options.headers && e.extend(p, this.options.headers), p) {
                    var f = p[h];
                ...
                if (this.options.params) {
                    ...
                    for (var y in "function" == typeof v && (v = v.call(this, t, r, t[0].upload.chunked ? this._getChunk(t[0], r) : null)), v) {
                        var g = v[y];
                        m.append(y, g)
                    }
                }
                var b = !0,
                    ...
                    w = void 0;
                try {
                    for (var F, z = t[Symbol.iterator](); !(b = (F = z.next()).done); b = !0) {
                        var x = F.value;
                ...
                this.options.uploadMultiple && this.emit("sendingmultiple", t, r, m), this._addFormElementData(m);
            ...
            value: function(t, n, i) {
                ...
                if (t[0].status !== e.CANCELED && 4 === n.readyState) {
                    ...
                    this._updateFilesUploadProgress(t), 200 <= n.status && n.status < 300 ? t[0].upload.chunked ? t[0].upload.finishedChunkUpload(this._getChunk(t[0], n)) : this._finished(t, r, i) : this._handleUploadError(t, n, r)
                }
            }
        }, {
            ...
            value: function(t, n, i) {
                ...
                try {
                    for (var l, s = t[Symbol.iterator](); !(r = (l = s.next()).done); r = !0) {
                        var u = l.value;
                        u.status = e.SUCCESS, this.emit("success", u, n, i), this.emit("complete", u)
                    }
                } catch (t) {
                    o = !0, a = t
                } finally {
            ...
            value: function(t, n, i) {
                ...
                try {
                    for (var l, s = t[Symbol.iterator](); !(r = (l = s.next()).done); r = !0) {
                        var u = l.value;
                        u.status = e.ERROR, this.emit("error", u, n, i), this.emit("complete", u)
                    }
                } catch (t) {
                    o = !0, a = t
                } finally {
    ...
    if (window.File && window.FileReader && window.FileList && window.Blob && window.FormData && document.querySelector)
        if ("classList" in document.createElement("a")) {
            var t = !0,
                ...
                i = void 0;
            try {
                for (var r, o = Dropzone.blacklistedBrowsers[Symbol.iterator](); !(t = (r = o.next()).done); t = !0) r.value.test(navigator.userAgent) && (e = !1)
            } catch (e) {
                n = !0, i = e
            } finally {
                try {
...
var contentLoaded = function(e, t) {
    function n(r) {
        if ("readystatechange" !== r.type || "complete" === o.readyState) return ("load" === r.type ? e : o)[s](u + r.type, n, !1), !i && (i = !0) ? t.call(e, r.type || r) : void 0
    }
    var i = !1,
        r = !0,
        o = e.document,
    ...
    if ("complete" !== o.readyState) {
        ...
        return o[l](u + "DOMContentLoaded", n, !1), o[l](u + "readystatechange", n, !1), e[l](u + "load", n, !1)
    }
};
